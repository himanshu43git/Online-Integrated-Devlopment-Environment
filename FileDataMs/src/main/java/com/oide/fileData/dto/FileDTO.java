...
public class FileDTO {
    ...
    /**
     * ID of the file record (Mongo ObjectId hex string). For create, this may be null.
     */
     ...
     * For create, this may be generated by the service.
     */
    private String storageFilename;

    /**
     * Timestamp when the file was uploaded. For create, this is set by the service.
     */
    private Instant uploadTime;

    /**
     * Map this DTO to a FileEntity for persistence.
     * For create: storageFilename and uploadTime may be null; fileId may be null for new entities.
     */
    public FileEntity toEntity() {
        ...
        entity.setFileContent(this.fileContent);
        return entity;
    }
